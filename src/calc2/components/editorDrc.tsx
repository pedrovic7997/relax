...
import { relalgFromDRCAstRoot, parseDRCSelect, AutoreplaceOperatorsMode, queryWithReplacedTRCOperatorsFromAst } from "db/relalg";
...
export class EditorDrc extends React.Component<Props, State> {
			...
			<EditorBase
				...
				execFunction={(self: EditorBase, text: string, offset) => {
					...
					if (warnings.length > 0) {
						self.addExecutionWarning(warningsStr);
					}
